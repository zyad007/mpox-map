...
const Indicator = ({
    ...
    return (
        <div className="w-full h-full flex flex-col justify-start items-end mt-10">

            <div className=" flex flex-col justify-center items-start border border-white p-5 w-2/3 rounded-md bg-blue-800 text-white mr-20">
            ...
            <div className="flex flex-col justify-center items-start border border-white p-5 w-2/3 rounded-md my-10 bg-blue-800 text-white mr-20">
